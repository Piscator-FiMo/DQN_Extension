# -*- coding: utf-8 -*-
"""noisy_linear_reinforcement_q_learning_HS_24.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14JjQdSZpjKt3JWrslrJ9eEa1CL8CW9W7
"""
...
episodes = 500
env = RecordVideo(env=gym.make("CartPole-v1", render_mode="rgb_array"), video_folder="./original-noise-training", episode_trigger=lambda x: x % 20 == 0 and x > 0 or x >= episodes - 10, fps=12)
...
Below, [num_episodes]{.title-ref} is set to 600 if a GPU is available,
